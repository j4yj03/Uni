...
# 8 "mcc_generated_files/../header.h" 2

# 1 "./mcc_generated_files/pin_manager.h" 1
# 136 "./mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 9 "mcc_generated_files/../header.h" 2
...
# 1 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC10-12Fxxx_DFP/1.3.46/xc8\\pic\\include\\__null.h" 1 3
# 9 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\c90\\conio.h" 2 3
...
void IOC_Handler(void){
    ...
    int state = PORTAbits.RA3;


    if(state)
    {
        TMR2_StopTimer();
        _delay((unsigned long)((20)*(250000/4000.0)));

        dice.current = (counter >= 125000) ? throwDice() : dice.current;


        (LATA = numbers[dice.current]);

        _delay((unsigned long)((15000)*(250000/4000.0)));
